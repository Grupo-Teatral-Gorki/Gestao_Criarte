...
export default function View() {
  ...
  useEffect(() => {
    ...
    const fetchProjectData = async () => {
      try {
        const response = await fetch("https://gorki-painel-admin-api.iglgxt.easypanel.host/project/view", {
          method: "POST",
          headers: {
  ...
  return (
    <div>
        ...
        <Table className="shad-table">
          <TableHeader>
            <TableRow style={{ color: "gray" }}>
              ...
              <TableHead style={{ display: 'flex', justifyContent: "center", alignItems: 'center' }}>Selecionado</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {proponentes &&
                ...
                <TableRow key={index}>
                  ...
                  <TableCell style={{ display: 'flex', justifyContent: "center" }}>
                    {proponente.is_selected ? (
                      <img width="15" height="15" src="https://img.icons8.com/ios-filled/50/40C057/checked-checkbox.png" alt="checked-checkbox" />
                    ) : (
                      <img width="15" height="15" src="https://img.icons8.com/ios-filled/50/FA5252/close-window.png" alt="close-window" />
                    )}
                  </TableCell>
                </TableRow>
              ))}
      ...
      {
  id_edital === 2 ? (
    <div style={{color: '#1d4a5d', maxWidth: '95%', backgroundColor: '#a6c7e3', marginLeft: 'auto', marginRight: 'auto', marginTop: '10px', borderRadius: '5px',}}>
    ...
    <div className="label-resumo-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? resumo_projeto : ""} disabled />
      </div>
    </div>
    <div className="label-relevancia-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.relevancia : ""} disabled />
      </div>
    </div>
    <div className="label-perfil-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.perfil : ""} disabled />
      </div>
    </div>
    <div className="label-expectativa-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.expectativa : ""} disabled />
      </div>
    </div>
    <div className="label-detalhamento-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.contrapartida : ""} disabled />
      </div>
    </div>
    <div className="label-medidas-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.democratizacao : ""} disabled />
      </div>
    </div>
    <div className="label-local-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.divulgacao : ""} disabled />
      </div>
    </div>
    <div className="label-afirmativas-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.afirmativas : ""} disabled />
      </div>
    </div>
    <div className="label-local-projeto">
      <span
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.local : ""} disabled />
      </div>
    </div>
    <div className="label-outras-projeto">
      ...
      <div className="content-box">
        <Textarea value={id_edital !== 2 ? descricaoParsed.outras : ""} disabled />
      </div>
    </div>
  </div>
  )
